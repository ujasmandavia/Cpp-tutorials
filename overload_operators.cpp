//Operator overloading, structures, function templetes, class templetes, templeted classes with multiple implementations
...
//Overload the '+' operator to add two structure
...
int main(){
  ...
  //Create a new struct and make it equal to the sum of the two wallets
